<template>
  <UCard v-if="!success">
    ...
    <form @submit.prevent="handleLogin">
      <UFormGroup label="Email" name="email" class="mb-4" :required="true"
        ...
        <UInput type="email" placeholder="Email" v-model="email" required></UInput>
      </UFormGroup>
  ...
  <UCard v-else>
    ...
    <div class="text-center">
      <p class="mb-4">We've sent an email to <strong>{{ email }}</strong> with a link to sign-in.</p>
